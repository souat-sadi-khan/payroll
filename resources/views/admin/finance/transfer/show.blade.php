<div class="card">
    <div class="card-header">
        <h6>{{_lang('View Transfer Full View Information')}}</h6>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-4 form-group">
                <label for="account_id">{{ _lang('From Account') }}</label>
                <input readonly type="text" class="form-control" value="{{ $model->from_account->account_name }}">
            </div>

            <div class="col-md-4 form-group">
                <label for="account_id">{{ _lang('To Account') }}</label>
                <input readonly type="text" class="form-control" value="{{ $model->to_account->account_name }}">
            </div>
