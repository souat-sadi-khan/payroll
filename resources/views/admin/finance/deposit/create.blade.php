<div class="card">
    <div class="card-header">
        <h6>{{_lang('Add New Deposit')}}</h6>
    </div>
    <div class="card-body">
        <form action="{{route('admin.finance.deposit.store')}}" method="post" id="content_form">
            @csrf
                <div class="row">
                    {{-- Account ID --}}
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <select name="category" id="category" class="form-control select" data-placeholder="Select One" required data-parsley-errors-container="category_error">
                            <option value="">{{ _lang('Select One') }}</option>
                            <option value="Envato">{{ _lang('Envato') }}</option>
                            <option value="Salary">{{ _lang('Salary') }}</option>
                            <option value="Other Income">{{ _lang('Other Income') }}</option>
                            <option value="Interest Income">{{ _lang('Interest Income') }}</option>
                            <option value="Part Time Income">{{ _lang('Part Time Income') }}</option>
                            <option value="Regular Income">{{ _lang('Regular Income') }}</option>
                            <option value="Other">{{ _lang('Other') }}</option>
                        </select>
