                            ...
                            <tr>
                                ...
                                <td class="text-center" width="25%"> 
                                    ...
                                    <div class="input-group col-md-12 mb-3">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control earning input_number" name="amount[]" placeholder="Enter Amount" required value="{{intval(round($amount))}}" {{$templaate_details->category == 'not_applicable' ? 'readonly' : ''}}>       
                                    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="25%"> 
                                ...
                                <div class="input-group col-md-12 mb-3">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control deduction input_number" name="amount[]" placeholder="Enter Amount" required value="{{intval(round($amount))}}" {{$templaate_details->category == 'not_applicable' ? 'readonly' : ''}}>       
                                </div>
                            </td>
                        </tr>
                    @endif
