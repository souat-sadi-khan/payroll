<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.attendance-type.update', $model->id)}}" method="post" id="content_form">
            @csrf
            @method('PATCH')
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea name="description" class="form-control" id="" placeholder="Enter Employee Attendance Type Description">{{$model->description}}</textarea>
                </div>
