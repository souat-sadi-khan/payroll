<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.attendance-type.store')}}" method="post" id="content_form">
            @csrf
            <div class="row">
                {{-- Employee Attendance Type Name --}}
                <div class="col-md-6 form-group">
                    <label for="name">{{_lang('Attendance Type Name')}} <span class="text-danger">*</span> </label>
                    <input autocomplete="off" type="text" name="name" id="name" class="form-control" placeholder="Enter Employee Attendance Type Name" required>
                </div>
                {{-- Employee Attendance Type Alias --}}
                <div class="col-md-6 form-group">
                    <label for="alias">{{_lang('Attendance Type Alias')}}</label>
                    <input autocomplete="off" type="text" name="alias" id="alias" class="form-control" placeholder="Enter Employee Attendance Type Alias" required>
                </div>
                ...
                <div class="col-md-6 form-group">
                    <label for="name">{{_lang('Attendance Type Is Active?')}} <span class="text-danger">*</span> </label>
                ...
                <div class="col-md-12 form-group">
                    <label for="name">{{_lang('Attendance Type Description')}} </label>
