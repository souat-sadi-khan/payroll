<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.category.update', $model->id)}}" method="post" id="content_form">
            @csrf
            @method('PATCH')
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <input autocomplete="off" type="text" name="name" value="{{$model->name}}" id="name" class="form-control" placeholder="Enter Employee Category Name" required>
                </div>
