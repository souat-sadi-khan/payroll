...
<head>
    ...
    <meta name="author" content="Souat Sadi Khan Sadik" />
    <meta name="description" content="Payroll Management System" />
    <link rel="icon" href="{{ asset('favicon.ico') }}" type="image/gif" sizes="64x64">
    <title> Payroll Management Software </title>
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/bootstrap.min.css') }}" crossorigin="anonymous">
    <!--    fontawesome cdn link-->
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/font.min.css') }}" crossorigin="anonymous">
    <!-- Stylesheets-->
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/rsanimations.css') }}">
    <!--    AOS - Animate on scroll library -->
    <link href="{{ asset('frontend/assets/css/aws.min.css') }}" rel="stylesheet">
    ...
    <section class="header-area" id="home" style="background:rgba(0, 0, 0, 0.7) url({{ asset('frontend/images/bg02.jpg') }});">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn-success rounded px-4 text-light" href="{{ route('login') }}"> {{ auth()->check() ? 'Admin Panel' : 'Log in'}}  </a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="container">
            <div class="col-md-12 my-auto text-center slidr-text text-light">
                <p class="h1 shorif mb-0 animated fadeInDown delay-1s text-light align-self-center"> Employee Payroll Management System </p>
                <h1 class="h3  animated  fadeInUp delay-2s">
                    Manage your Employee Information Using our Employee Payroll Management System
                </h1>
                <p class="h5 mt-4">
                    Employee Information are very much important for any office or any organization. Handle All of the employee information with a huge database schema and super fast processing speed using our <b>Employee Payroll Management System.</b> 
                </p>

                <a href="#contact" class="btn btn-success px-4 py-2"> Try to Free </a>
            </div>
        </div>
    </section>
    <!--    about us area start -->
