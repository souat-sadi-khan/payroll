...
<head>
    ...
    <title>{{ isset($title) ? $title .' | '. get_option('site_title') :  get_option('site_title')}} | Documentation</title>

    <link rel="shortcut icon" href="{{asset(get_option('favicon')?'storage/logo/'.get_option('favicon'):'favicon.ico')}}" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('doc/js/syntax-highlighter/styles/shCore.css') }}" media="all">
    <link rel="stylesheet" type="text/css" href="{{ asset('doc/js/syntax-highlighter/styles/shThemeRDark.css') }}" media="all">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="big-title text-center">
                            <h1>{{ isset($title) ? $title : 'Payroll Manager'}}</h1>
                            <p class="lead">{{  get_option('site_title') ?  get_option('site_title') : 'Complete Payroll Management System With HR Stystem'}} | version 0.1 </p>
                        </div>
                        <!-- end title -->
                    </div>
                    <!-- end 12 -->
