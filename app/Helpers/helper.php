...
function employee_department($employee_id) {
	$designation_description = EmployeeDesignation::where('employee_id', $employee_id)->latest()->first();
	dd($designation_description);
	if($designation_description) {
...
function current_designation($id){
	...
	$designation = ($emp_d AND $emp_d->designation)?$emp_d->designation->name:"";
