...
class SettingController extends Controller
{
        ...
        if ($request->isMethod('get')) {
            ...
            if($request->hasFile('logo')) {
                ...
                if($host == 1) {
					...
					$fileName = Storage::disk('uploads')->put('logo', $request->file('logo'));
    ...
    public function MainConfiguration() {
        return view('admin.setting.mail_setting');
    }

    // SmsConfiguration
    public function SmsConfiguration() {
        return view('admin.setting.sms_setting');
    }

    // ModudelConfiguraion
    public function ModudelConfiguraion() {
        return view('admin.setting.module_setting');
    }
}
